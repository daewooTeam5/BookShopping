...
public interface PaymentRepository {
    ...
    @Select("SELECT p.id, p.CREATED_AT as createdAt, b.title, b.IMAGE, b.GENRE, b.AUTHOR, b.PAGE, b.PRICE, b.PUBLISHER, p.quantity ,p.receipt_id as receiptId" +
    ...
    @Select("SELECT SUM(p.quantity) FROM payment p JOIN BOOK b ON b.ID = p.BOOK_ID WHERE p.ACCOUNT_ID = #{accountId}")
    Integer getTotalQuantityByAccountId(Long accountId);
}
